...
const CardTaiwind = (props) => {
  const amountClasses = `text-lg font-bold text-transparent bg-clip-text ${
    props.primary ? "bg-primary-radient" : "bg-secondary-radient"
  }`;
      ...
      <div className="absolute left-2/4 -translate-x-2/4 translate-y-2/4 bottom-0 bg-white z-10 rounded-[20px] p-5 w-[calc(100%-36px)]">
        <div className="flex justify-between items-center mb-8">
          <div className="flex items-center gap-x-3">
            ...
            />
            <span className=" font-[300] text-base text-[#333]">@zndrson</span>
          </div>
        ...
        <div className="flex justify-between items-center">
          <h3 className={`${props.fontSize || "text-lg"} font-medium`}>
            Cosmic Perspective
          </h3>
